            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                user.updateEmail(change.getText().toString()).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        {
                            Toast.makeText(editmail.this, "Email Changed" + " Current Email is " + change.getText().toString(), Toast.LENGTH_LONG).show();
                       } else  Toast.makeText(editmail.this, "Erreur" , Toast.LENGTH_LONG).show();
                    }
                });
            }
        });
